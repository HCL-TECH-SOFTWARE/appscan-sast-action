...
| incremental_scan | **(Coming Soon)** Only scan files that were added or modified in a pull request. | false |
| personal_scan | Make this a [personal scan](https://help.hcltechsw.com/appscan/ASoC/appseccloud_scans_personal.html). | false |
| sast_scan_id | **(Coming Soon)** The ID of an existing SAST scan to use for running a rescan. | null |
| sca_scan_id | **(Coming Soon)** The ID of an existing SCA scan to use for running a rescan. | null |
